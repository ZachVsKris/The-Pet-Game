...
## v2.1.1 deployment fix

- Upgraded Next.js from 15.4.2 to 15.4.8, the patched 15.4 release for CVE-2025-66478
- Changed `align-items: end` to `align-items: flex-end` to remove the Autoprefixer compatibility warning
