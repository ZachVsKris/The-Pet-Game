...
export const questions: Question[] = [
  {
    ...
    prompt: "Which dog name is more popular?", metric: "rank", left: dog("Luna", 1), right: dog("Willow", 6),
  ...
  },
  {
    ...
    prompt: "Which dog name is more popular?", metric: "rank", left: dog("Max", 1), right: dog("Bear", 6),
  ...
  },
  {
    ...
    prompt: "Which dog name is more popular?", metric: "rank", left: dog("Bella", 2), right: dog("Daisy", 3),
    sourceName: "American Kennel Club", sourceUrl: "https://www.akc.org/expert-advice/lifestyle/most-popular-dog-names/", sourceYear: "2025", scope: "AKC registrations and Canine Partners enrollments", fact: "Bella narrowly edged Daisy in AKC’s 2025 list.", difficulty: "Medium"
  },
  {
    id: "n4", round: "names", roundTitle: "Dog Names", eyebrow: "🇺🇸 AKC • MALE NAMES • 2025",
    prompt: "Which dog name is more popular?", metric: "rank", left: dog("Hank", 2), right: dog("Teddy", 3),
    sourceName: "American Kennel Club", sourceUrl: "https://www.akc.org/expert-advice/lifestyle/most-popular-dog-names/", sourceYear: "2025", scope: "AKC registrations and Canine Partners enrollments", fact: "Hank narrowly edged Teddy in AKC’s 2025 list.", difficulty: "Medium"
  },
  {
    id: "n5", round: "names", roundTitle: "Dog Names", eyebrow: "🇺🇸 AKC • FEMALE NAMES • 2025",
    prompt: "Which dog name is more popular?", metric: "rank", left: dog("Daisy", 3), right: dog("Lucy", 4),
    sourceName: "American Kennel Club", sourceUrl: "https://www.akc.org/expert-advice/lifestyle/most-popular-dog-names/", sourceYear: "2025", scope: "AKC registrations and Canine Partners enrollments", fact: "Daisy and Lucy were separated by a single place.", difficulty: "Medium"
  },
  {
    id: "n6", round: "names", roundTitle: "Dog Names", eyebrow: "🇺🇸 AKC • MALE NAMES • 2025",
    prompt: "Which dog name is more popular?", metric: "rank", left: dog("Teddy", 3), right: dog("Cooper", 4),
    sourceName: "American Kennel Club", sourceUrl: "https://www.akc.org/expert-advice/lifestyle/most-popular-dog-names/", sourceYear: "2025", scope: "AKC registrations and Canine Partners enrollments", fact: "Teddy and Cooper were separated by a single place.", difficulty: "Medium"
  },
  {
    id: "n7", round: "names", roundTitle: "Dog Names", eyebrow: "🇺🇸 AKC • FEMALE NAMES • 2025",
    prompt: "Which dog name is more popular?", metric: "rank", left: dog("Ruby", 5), right: dog("Willow", 6),
    sourceName: "American Kennel Club", sourceUrl: "https://www.akc.org/expert-advice/lifestyle/most-popular-dog-names/", sourceYear: "2025", scope: "AKC registrations and Canine Partners enrollments", fact: "Ruby and Willow were separated by a single place.", difficulty: "Medium"
  },
  {
    id: "n8", round: "names", roundTitle: "Dog Names", eyebrow: "🇺🇸 AKC • MALE NAMES • 2025",
    prompt: "Which dog name is more popular?", metric: "rank", left: dog("Gus", 5), right: dog("Bear", 6),
    sourceName: "American Kennel Club", sourceUrl: "https://www.akc.org/expert-advice/lifestyle/most-popular-dog-names/", sourceYear: "2025", scope: "AKC registrations and Canine Partners enrollments", fact: "Gus and Bear were separated by a single place.", difficulty: "Medium"
  },
  {
    id: "n9", round: "names", roundTitle: "Dog Names", eyebrow: "🇺🇸 AKC • FEMALE NAMES • 2025",
    prompt: "Which dog name is more popular?", metric: "rank", left: dog("Maggie", 7), right: dog("Penny", 8),
    sourceName: "American Kennel Club", sourceUrl: "https://www.akc.org/expert-advice/lifestyle/most-popular-dog-names/", sourceYear: "2025", scope: "AKC registrations and Canine Partners enrollments", fact: "Maggie narrowly outranked Penny.", difficulty: "Hard"
  },
  {
    id: "n10", round: "names", roundTitle: "Dog Names", eyebrow: "🇺🇸 AKC • MALE NAMES • 2025",
    prompt: "Which dog name is more popular?", metric: "rank", left: dog("Duke", 7), right: dog("Maverick", 8),
    sourceName: "American Kennel Club", sourceUrl: "https://www.akc.org/expert-advice/lifestyle/most-popular-dog-names/", sourceYear: "2025", scope: "AKC registrations and Canine Partners enrollments", fact: "Duke narrowly outranked Maverick.", difficulty: "Hard"
  },

  {
    id: "b1", round: "breeds", roundTitle: "Breeds", eyebrow: "🇺🇸 AKC DOG BREEDS • 2025",
    prompt: "Which breed is more popular?", metric: "rank", left: dog("French Bulldog", 1), right: dog("Poodle", 5),
  ...
  },
  {
    ...
    prompt: "Which breed is more popular?", metric: "rank", left: dog("Labrador Retriever", 2), right: dog("Dachshund", 6),
  ...
  },
  {
    ...
    prompt: "Which breed is more popular?", metric: "rank", left: dog("Golden Retriever", 3), right: dog("German Shepherd Dog", 4),
    sourceName: "American Kennel Club", sourceUrl: "https://www.akc.org/most-popular-breeds/", sourceYear: "2025", scope: "AKC registration rankings", fact: "Golden Retrievers and German Shepherd Dogs were separated by one place.", difficulty: "Medium"
  },
  {
    id: "b4", round: "breeds", roundTitle: "Breeds", eyebrow: "🇺🇸 AKC DOG BREEDS • 2025",
    prompt: "Which breed is more popular?", metric: "rank", left: dog("Poodle", 5), right: dog("Dachshund", 6),
    sourceName: "American Kennel Club", sourceUrl: "https://www.akc.org/most-popular-breeds/", sourceYear: "2025", scope: "AKC registration rankings", fact: "Poodles narrowly outranked Dachshunds.", difficulty: "Medium"
  },
  {
    id: "b5", round: "breeds", roundTitle: "Breeds", eyebrow: "🇺🇸 AKC DOG BREEDS • 2025",
    prompt: "Which breed is more popular?", metric: "rank", left: dog("Beagle", 7), right: dog("Rottweiler", 8),
    sourceName: "American Kennel Club", sourceUrl: "https://www.akc.org/most-popular-breeds/", sourceYear: "2025", scope: "AKC registration rankings", fact: "Beagles and Rottweilers were separated by one place.", difficulty: "Medium"
  },
  {
    id: "b6", round: "breeds", roundTitle: "Breeds", eyebrow: "CFA PEDIGREED CAT BREEDS • 2025",
    prompt: "Which cat breed is more popular?", metric: "rank", left: cat("Maine Coon", 2), right: cat("Bengal", 5),
  ...
  },
  {
    ...
    prompt: "Which cat breed is more popular?", metric: "rank", left: cat("Ragdoll", 1), right: cat("British Shorthair", 3),
  ...
  },
  {
    ...
    prompt: "Which cat breed is more popular?", metric: "rank", left: cat("Bengal", 5), right: cat("Sphynx", 8),
  ...
  },
  {
    ...
    prompt: "Which breed is more popular?", metric: "rank", left: dog("Dachshund", 6), right: dog("Beagle", 7),
  ...
  },
  {
    ...
    prompt: "Which cat breed is more popular?", metric: "rank", left: cat("British Shorthair", 3), right: cat("Persian", 4),
...

  {
    ...
    prompt: "Which companion pet is more popular?", metric: "percent", left: pet("Rabbits", 2.4, "🐰"), right: pet("Snakes", 1.1, "🐍"),
  ...
  },
  {
    ...
    prompt: "Which companion-pet group is more popular?", metric: "percent", left: pet("Fish", 11.0, "🐠"), right: pet("Reptiles", 3.0, "🦎"),
  ...
  },
  {
    ...
    prompt: "Which companion pet is more popular?", metric: "percent", left: pet("Guinea pigs", 1.8, "🐹"), right: pet("Horses", 1.0, "🐴"),
  ...
  },
  {
    ...
    prompt: "Which companion-pet group is more popular?", metric: "percent", left: pet("Birds", 10.0, "🦜"), right: pet("Small mammals", 6.0, "🐹"),
  ...
  },
  {
    ...
    prompt: "Which companion pet is more popular?", metric: "percent", left: pet("Turtles and tortoises", 1.3, "🐢"), right: pet("Snakes", 1.1, "🐍"),
